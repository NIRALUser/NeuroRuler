...
EXPECTED_NUM_FIELDS_IN_CLI_CONFIG: int = 12
"""Number of expected fields in the CLI config file. If the number of fields discovered does not match this, an exception will be raised."""
