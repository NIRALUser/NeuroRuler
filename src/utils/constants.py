...
"""Maps the `xyzt_units` metadata field (it's a str) of a NIfTI file to physical meaning.
...
The name is `NIFTI_UNITS` because it seems like NRRD images don't have unit information in metadata."""
