...
class MainWindow(QMainWindow):
    ...
    def goto_circumference(self):
        ...
        circumference: float = get_contour_length(process_slice_and_get_contour(curr_mri_image.get_rotated_slice()))
        circumference_window.circumference_label.setText(f'Circumference: {circumference}')
        circumference_window.slice_settings_text.setText(f'X rotation: {curr_mri_image.get_theta_x()}°\nY rotation: {curr_mri_image.get_theta_y()}°\nZ rotation: {curr_mri_image.get_theta_z()}°\nSlice: {curr_mri_image.get_slice_z()}')
    ...
    def save_curr_slice_to_img_dir(self):
        ...
        save_sitk_slice_to_file(globs.IMAGE_LIST[index].get_rotated_slice(), IMG_DIR / f'{index}.{IMAGE_EXTENSION}')
    ...
    def render_curr_image_from_img_dir(self):
        ...
        curr_mri_image: MRIImage = globs.IMAGE_LIST.get_curr_mri_image()
        index: int = globs.IMAGE_LIST.get_index()
        filepath = IMG_DIR / f'{index}.{IMAGE_EXTENSION}'
